...
export type ReportStatus = typeof statusPending | typeof statusGenerated | typeof statusFailed;
...
export class ReportEntity {
    ...
    private static validateStatus(status: ReportStatus): void {
        const validStatuses: ReportStatus[] = [statusPending, statusGenerated, statusFailed];
