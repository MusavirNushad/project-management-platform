...
import { ReportEntity, ReportStatus } from '../../domain/entities/report.entity';
...
export class ReportMapper {
    ...
    static toPrismaCreate(report: ReportEntity): Prisma.ReportUncheckedCreateInput {
        return {
            id: report.getId(),
    ...
    static toPrismaUpdate(report: ReportEntity): Prisma.ReportUncheckedUpdateInput {
        return {
            name: report.getName(),
            file: report.getFile(),
            status: report.getStatus(),
