...
export interface SprintRepositoryPort {
  ...
  saveSprintTask(sprintTask: SprintTaskEntity): Promise<SprintTaskDetails>;

  findSprintTaskById(
    sprintTaskId: SprintTaskId,
  ): Promise<SprintTaskDetails | null>;

  updateSprintTask(sprintTask: SprintTaskEntity): Promise<SprintTaskDetails>;
}
